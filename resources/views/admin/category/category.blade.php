        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 relative bottom-6">
                    <form class="p-6" action="{{ url('admin/addCategory') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="flex">
                            <div class="mb-6">
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Category Name</label>
                                <input type="text" id="name" name="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[350px] p-2.5" placeholder="Enter Product Name" required>
                            </div>
                            <div class="mb-6  ml-6">
                                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 ">Slug</label>
                                <input type="text" id="password" name="slug" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[350px] p-2.5" placeholder="Enter Product Type" required>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="mb-6 mt-6  ml-6">
                                ...
                                <input type="text" id="repeat-password" name="meta_title" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[350px] p-2.5" placeholder="Enter Title">
                            </div>
                            <div class="mb-6 mt-6 ml-6">
                                <label for="repeat-password" class="block mb-2 text-sm font-medium text-gray-900 ">Meta Keyword</label>
                                <input type="text" id="repeat-password" name="meta_keyword" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[250px] p-2.5" placeholder="Enter Keyword">
                            </div>
                        </div>
